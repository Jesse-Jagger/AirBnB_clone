...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_two_reviews_unique_ids(self):
        r_v1 = Review()
        r_v2 = Review()
        self.assertNotEqual(r_v1.id, r_v2.id)

    def test_two_reviews_different_created_at(self):
        r_v1 = Review()
        sleep(0.05)
        r_v2 = Review()
        self.assertLess(r_v1.created_at, r_v2.created_at)

    def test_two_reviews_different_updated_at(self):
        r_v1 = Review()
        sleep(0.05)
        r_v2 = Review()
        self.assertLess(r_v1.updated_at, r_v2.updated_at)
